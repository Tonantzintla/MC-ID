    ...
    <section>
      <div class="relative pt-24 md:pt-36">
        <div class="mx-auto max-w-7xl px-6">
          <div class="text-center sm:mx-auto lg:mt-0 lg:mr-auto">
            ...
            <p class="mx-auto mt-8 max-w-2xl text-lg text-balance">
              Most secure way to login with your Minecraft account, built with users and developers in mind.
            </p>
            ...
            <div class="mt-12 flex flex-col items-center justify-center gap-2 md:flex-row">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                class="rounded-xl px-5 transition-all dark:hover:bg-accent">For Developers</Button>
            </div>
          </div>
        </div>
        ...
        <div class="relative mt-8 overflow-hidden px-2 sm:mt-12 sm:mr-0 md:mt-20">
          <div
            class="relative mx-auto max-w-6xl overflow-hidden rounded-2xl border bg-background p-4 shadow-lg inset-shadow-2xs shadow-zinc-950/15 ring-background inset-shadow-white/20">
            {#key siteWidth.current}
              <div bind:this={minecraftAvatarContainer} class="relative w-full">
                ...
                <canvas
                  ...
                  class="relative size-full transform-gpu overflow-hidden rounded-lg opacity-0 transition-all duration-[3s] data-[loaded=true]:opacity-100"
