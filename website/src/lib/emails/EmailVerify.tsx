        ...
        <Body className="mx-auto my-auto bg-black px-2 font-sans">
          <Container className="mx-auto my-[40px] max-w-[465px] rounded-xl border border-solid border-[#ffffff1a] bg-black p-[20px]">
            ...
            <Text className="mt-[16px] text-[14px] leading-[24px] text-[#e6e6e6]">
              Thank you for signing up for MC-ID! Please verify your email address by clicking the button below.
            </Text>
            <Text className="mt-[16px] text-[14px] leading-[24px] text-[#e6e6e6]">
            ...
            <Section className="text-center">
              <Link href={verifyUrl} className="break-all text-[14px] leading-[24px] text-[#00bc7d]" target="_blank" rel="noopener noreferrer">
                {verifyUrl}
              </Link>
            </Section>
          </Container>
