...
- **Client Secret:** Your application's Client Secret (server-side only).
- **Authentication method:** Select `client_secret_post` when registering the app for this example.
