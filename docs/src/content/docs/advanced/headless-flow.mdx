...
<Code
  code={`curl -X POST https://mc-id.com/api/v1/codes/request \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer YOUR_API_KEY" \\
  -d '{"uuid": "069a79f444e94726a5befca90e38aaf5"}'`}
  lang="bash"
  mark={["mc-id.com/api/v1/codes/request", "YOUR_API_KEY"]}
/>
...
<Code
  code={`curl -X POST https://mc-id.com/api/v1/codes/verify \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer YOUR_API_KEY" \\
  -d '{"code": "123456", "uuid": "069a79f444e94726a5befca90e38aaf5"}'`}
  lang="bash"
  mark={["mc-id.com/api/v1/codes/verify", "YOUR_API_KEY", "code"]}
/>
